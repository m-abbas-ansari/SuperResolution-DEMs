...
class EncoderTransformer(nn.Module):
    def __init__(self, img_size=512, patch_size=16, in_chans=1, num_classes=1000, embed_dims=[64, 128, 256, 512],
...
class EncoderTransformerV2(nn.Module):
    def __init__(self, img_size=512, patch_size=16, in_chans=1, num_classes=1, embed_dims=[32, 64, 128, 320, 512],
...
class OverlapPatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=7, stride=4, in_chans=1, embed_dim=768):  # 224 -> 512 ,3->1
        super().__init__()
...
class TransSARV2(nn.Module):
    ...
    def __init__(self, path=None, **kwargs):
        ...
        self.Tenc = EncoderTransformerV2(img_size=512, patch_size=16, in_chans=1, num_classes=1,
